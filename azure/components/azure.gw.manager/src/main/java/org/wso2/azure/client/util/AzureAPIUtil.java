...
public class AzureAPIUtil {
    ...
    public static String deployRestAPI(API api, ApiManagementManager manager, String resourceGroup, String serviceName) {
        try{
            ...
            ApiContract apiContract = manager.apis()
                    ...
                    .create();
            log.info("API deployed successfully to Azure Gateway: \n" + apiContract.toString());
