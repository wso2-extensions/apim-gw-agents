Feature: Testing Ratelimit feature
  ...
  Scenario: Testing Resource level rate limiiting for REST API
    ...
    Then I set headers
      | Authorization | Bearer ${accessToken} |
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/employee/" with body ""
    And I eventually receive 200 response code, not accepting
      | 429 |
      | 401 |
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/employee/" with body ""
    ...
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/employee/" with body ""
    Then the response status code should be 429
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/withoutrl/" with body ""
    Then the response status code should be 200
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/withoutrl/" with body ""
    Then the response status code should be 200
    And I send "GET" request to "https://default.gw.wso2.com:8443/simple-rl-r/3.14/withoutrl/" with body ""
