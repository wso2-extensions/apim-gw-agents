...
require (
	...
	github.com/wso2-extensions/apim-gw-agents/apk/agent v0.0.0-00010101000000-000000000000
	github.com/wso2-extensions/apim-gw-agents/kong/agent v0.0.0-00010101000000-000000000000
...
replace github.com/wso2-extensions/apim-gw-agents/apk/agent => ../apk/agent

replace github.com/wso2-extensions/apim-gw-agents/kong/agent => ../kong/agent
